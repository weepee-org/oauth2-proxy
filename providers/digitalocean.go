...
func NewDigitalOceanProvider(p *ProviderData) *DigitalOceanProvider {
	p.setProviderDefaults(digitalOceanProviderName, digitalOceanDefaultLoginURL, digitalOceanDefaultRedeemURL, digitalOceanDefaultProfileURL, digitalOceanDefaultProfileURL, digitalOceanDefaultScope)
