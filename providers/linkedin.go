...
func NewLinkedInProvider(p *ProviderData) *LinkedInProvider {
	p.setProviderDefaults(linkedinProviderName, linkedinDefaultLoginURL, linkedinDefaultRedeemURL, linkedinDefaultProfileURL, linkedinDefaultProfileURL, linkedinDefaultScope)
